...
export const getProjectsState = createFeatureSelector<State, ClientState>(
  'clients'
);
...
export const getClientItemState = createSelector(
  getProjectsState,
  state => state.item
);
...
export const getClientsOffset = createSelector(
  getClientListState,
  fromList.getOffset
);

export const getClientsSortProp = createSelector(
  getClientListState,
  fromList.getSortProp
);
export const getClientsSortDir = createSelector(
  getClientListState,
  fromList.getSortDir
);
...
export const getClientItemPending = createSelector(
  getClientItemState,
  fromItem.getPending
);
export const getClientItemError = createSelector(
  getClientItemState,
  fromItem.getError
);
